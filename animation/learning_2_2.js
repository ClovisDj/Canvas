...
function update(){
  ...
  // for (var j = 0; j < alphaParam; j++) {
  //   if (lineR.xTo > 50 + 20*j && lineR.xTo < 50 + 20*(j+1) || lineR.xTo < -50 - 20*j && lineR.xTo > -50 - 20*(j+1)) {
  //     lineR.strokeStyle = rgba(255, 255, 255, 1 - 0.1*j);
  //   }
  // }
  //
  // for (var j = 0; j < alphaParam; j++) {
  //   if (lineL.xTo > 50 + 20*j && lineL.xTo < 50 + 20*(j+1) || lineL.xTo < -50 - 20*j && lineL.xTo > -50 - 20*(j+1)) {
  //     lineL.ctx.globalAlpha =rgba(255, 255, 255, 1 - 0.1*j);
  //   }
  // }
